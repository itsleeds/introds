...
These are worked solutions. We strongly recommend attempting to debug the Python and R problem scripts in the [Tasks section](index.qmd) before reviewing these solutions. Learning to debug is a crucial data science skill!
:::
...
#| fig-height: 6
#| fig-align: center
#| fig-cap: "Various Outputs from the Excel Exercise (Python)"
...
#| fig-height: 6
#| fig-align: center
#| fig-cap: "Various Outputs from the Excel Exercise (R)"
...
#| fig-height: 6
#| fig-align: center
#| fig-cap: "Various Outputs from the SPSS Exercise (Python)"
...
#| fig-height: 6
#| fig-align: center
#| fig-cap: "Various Outputs from the SPSS Exercise (R)"
...
# var.equal = TRUE matches the Python version above; R's default is Welch.
