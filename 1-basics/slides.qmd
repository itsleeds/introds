...
Versatile IDE supporting multiple languages including Python and R
...
**Popular Extensions**: Python, Pylance, Jupyter, R, Quarto

------------------------------------------------------------------------

### Positron

New IDE from Posit (makers of RStudio) supporting Python and R equally
...
**Tip**: Customise the layout via View → Panes → Pane Layout
...
``` python
# Calling methods and chaining operations with '.'
text = "  introduction to data science  "
clean_text = text.strip().title()
print(clean_text)  # "Introduction To Data Science"
```
...
✅ Know your IDE (VS Code, Positron, or RStudio)

✅ Understand basic data types in Python

✅ Know the difference between data structures

✅ Organise your work with folder structure
