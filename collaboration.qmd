...
**Note:** This content and the associated exercises are **bonus material** and are **not expected** to be completed during the 3-hour session. We recommend reading the "Introduction to GitHub" course on [GitHub Skills](https://skills.github.com/) before attempting the exercises in this area.
